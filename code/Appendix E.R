...
# FPcover_low_est #
################### 
appE_b1 <- ggplot(data=dataFPsmall, aes(x=TOTP_avg,y=FPcover_low_est)) + geom_point() 
appE_b1 <- appE_b1 + stat_smooth(method=glm, family=binomial, se=F)
appE_b1 <- appE_b1 + xlab("Total P (mg/L)") + ylab("Floating plant cover(%)")
appE_b1 <- appE_b1 + geom_text(aes(x=0.01,y=1,label="d)"),size=7)
...
appE_b2 <- ggplot(data=dataFPsmall, aes(x=TOTP_avg,y=FPcover_low_est)) + geom_point() 
...
appE_b2 <- appE_b2 + geom_text(aes(x=0.01,y=1,label="e)"),size=7)
appE_b2 <- appE_b2 + geom_vline(xintercept=breakpoint02,colour="red",size=1,linetype="longdash") # add vertical line @ threshold value 
appE_b2 <- appE_b2 + scale_x_log10()
appE_b2 <- appE_b2 + theme(legend.position="none")
y_breaks <- seq(0,1,0.25)
y_labels <- as.character(y_breaks*100)
...
dataFPsmall$third_appE <- ifelse(dataFPsmall$FPcover_low_est >= 0.6666, "greater", "lesser")

appE_b3 <- ggplot(dataFPsmall,aes(x=TOTP_avg,y=FPcover_low_est)) + geom_point() 
appE_b3 <- appE_b3 + stat_smooth(method=glm, family=binomial, se=F,aes(fill=factor(third_appE))) 
appE_b3 <- appE_b3 + xlab("Total P (mg/L)") + ylab("Floating plant cover(%)")
appE_b3 <- appE_b3 + geom_text(aes(x=0.01,y=1,label="f)"),size=7)
appE_b3 <- appE_b3 + scale_x_log10()
appE_b3 <- appE_b3 + theme(legend.position="none")
y_breaks <- seq(0,1,0.25)
y_labels <- as.character(y_breaks*100)
...
appE_b3 <- appE_b3 + geom_vline(xintercept=0.45717,colour="red",size=1,linetype="longdash") # add vertical line @ upper threshold value 
appE_b3 
...
# 8 removed       #
################### 
appE_c1 <- ggplot(data=dataFPsmall_noshifts, aes(x=TOTP_avg,y=FPcover_max)) + geom_point() 
appE_c1 <- appE_c1 + stat_smooth(method=glm, family=binomial, se=F)
appE_c1 <- appE_c1 + xlab("Total P (mg/L)") + ylab("Floating plant cover(%)")
appE_c1 <- appE_c1 + geom_text(aes(x=0.01,y=1,label="g)"),size=7)
...
appE_c2 <- ggplot(data=dataFPsmall_noshifts, aes(x=TOTP_avg,y=FPcover_max)) + geom_point() 
...
appE_c2  <- appE_c2  + geom_text(aes(x=0.01,y=1,label="h)"),size=7)
appE_c2  <- appE_c2  + geom_vline(xintercept=breakpoint02,colour="red",size=1,linetype="longdash") # add vertical line @ threshold value 
appE_c2  <- appE_c2  + scale_x_log10()
appE_c2  <- appE_c2  + theme(legend.position="none")
y_breaks <- seq(0,1,0.25)
y_labels <- as.character(y_breaks*100)
...
###################
# partition data: FPcover_max >= 0.6666 and FPcover_max < 0.6666 
dataFPsmall_noshifts$third_appE <- ifelse(dataFPsmall_noshifts$FPcover_max >= 0.6666, "greater", "lesser")

appE_c3 <- ggplot(dataFPsmall_noshifts,aes(x=TOTP_avg,y=FPcover_max)) + geom_point() 
appE_c3 <- appE_c3 + stat_smooth(method=glm, family=binomial, se=F,aes(fill=factor(third_appE))) 
appE_c3 <- appE_c3 + xlab("Total P (mg/L)") + ylab("Floating plant cover(%)")
appE_c3 <- appE_c3 + geom_text(aes(x=0.01,y=1,label="i)"),size=7)
appE_c3 <- appE_c3 + scale_x_log10()
appE_c3 <- appE_c3 + theme(legend.position="none")
y_breaks <- seq(0,1,0.25)
y_labels <- as.character(y_breaks*100)
...
appE_c3 <- appE_c3 + geom_vline(xintercept=0.20642,colour="red",size=1,linetype="longdash") # add vertical line @ upper threshold value 
appE_c3 
...
appE_a1 <- ggplot(data=dataFPsmall, aes(x=TOTP_avg,y=FPcover_max)) + geom_point() 
appE_a1 <- appE_a1 + stat_smooth(method=glm, family=binomial, se=F)
appE_a1 <- appE_a1 + xlab("Total P (mg/L)") + ylab("Floating plant cover(%)")
appE_a1 <- appE_a1 + geom_text(aes(x=0.01,y=1,label="a)"),size=7)
...
appE_a2 <- ggplot(data=dataFPsmall, aes(x=TOTP_avg,y=FPcover_max)) + geom_point() 
appE_a2 <- appE_a2 + stat_smooth(method=glm, family=binomial, se=F,aes(fill=factor(breakpoint02)))
appE_a2 <- appE_a2 + xlab("Total P (mg/L)") + ylab("Floating plant cover(%)")
appE_a2 <- appE_a2 + geom_text(aes(x=0.01,y=1,label="b)"),size=7)
appE_a2 <- appE_a2 + geom_vline(xintercept=breakpoint02,colour="red",size=1,linetype="longdash") # add vertical line @ threshold value 
appE_a2 <- appE_a2 + scale_x_log10()
appE_a2 <- appE_a2 + theme(legend.position="none")
y_breaks <- seq(0,1,0.25)
y_labels <- as.character(y_breaks*100)
appE_a2 <- appE_a2 + scale_y_continuous(breaks=y_breaks,labels=y_labels)
appE_a2

appE_a3 <- ggplot(dataFPsmall,aes(x=TOTP_avg,y=FPcover_max)) + geom_point() 
